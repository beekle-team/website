...
// 公開文面だけに適用する保守的な置換。
// 事実・数値・検索意図は変えず、過剰な比喩、断定、同じ営業語の反復だけを直す。
export const NATURAL_JAPANESE_REPLACEMENTS: CopyReplacement[] = [
  ...
  {
    before: '3年後に必ず後悔する3つのこと',
    after: '3年後の負担になりやすい3つのこと',
    reason: '将来を断定する表現を、リスクを示す表現へ変更',
  },
  {
    before: '必ず失敗します',
    after: '失敗しやすくなります',
    reason: '結果を断定せず、リスクの高さとして表現',
  },
  {
    before: '必ず失敗する',
    after: '失敗しやすい',
  ...
  },
  {
    ...
    reason: '見出しの営業定型語を、内容が分かる表現へ変更',
  },
  {
    before: 'Web・モバイルアプリ開発｜要件定義からAI駆動開発・運用まで一気通貫',
    after: 'Web・モバイルアプリ開発｜要件定義からAI駆動開発・運用まで対応',
    reason: 'SEO語を保ったまま、反復する営業定型語を削減',
  },
  {
    before: '要件定義からデザイン・実装・運用まで一気通貫でサポート',
    after: '要件定義からデザイン・実装・運用まで同じチームで支援',
    reason: '「一気通貫」の意味を具体化',
  },
  {
