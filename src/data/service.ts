  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '固定の価格表は置いていません。NDA締結後に実データを確認し、0円で検証用デモを作ってから、望みがある場合だけPoCへ進みます。PoC以降は準委任（月額）で、単価は100〜150万円が目安です。デモで分かったデータの状態と難しさをもとに、確かめる範囲と体制を再見積もりして提示します。合わなければ、デモの段階で終了でき、費用はかかりません。',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'NDA締結後にFAQや過去の問い合わせデータを確認し、0円で検証用デモを作ります。望みがあれば、デモで見えた範囲に絞ってPoCを準委任（月額）で再見積もりし、マルチチャネル対応・有人切り替え・分析ダッシュボードなどの本番化も同じ体制で続けます。期間はFAQの件数と連携先で変わるため、デモの結果を見て提示します。',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'NDA締結後に対象業務のデータと連携先を確認し、1業務フローに絞って0円で検証用デモを作ります。望みがあれば、デモで見えた不確実性だけを範囲にしてPoCを準委任（月額）で再見積もりし、ツール連携・ガバナンス設計・運用基盤を含む本番化も同じ体制で進めます。対象業務の複雑さと連携するシステム数で期間と体制が変わります。',
      },
      {
