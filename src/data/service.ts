  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '固定の価格表は置いていません。NDA締結後に実データを確認し、0円で検証用デモを作ってから、望みがある場合だけPoCへ進みます。PoC以降は準委任（月額）で、単価は職種別に公開しています。デモで分かったデータの状態と難しさをもとに、確かめる範囲と体制を再見積もりして提示します。合わなければ、デモの段階で終了でき、費用はかかりません。',
      },
      {
