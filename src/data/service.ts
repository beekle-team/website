...
export const services: ServiceDetail[] = [
  {
    ...
    caseStudies: [
      {
        title: '他社が3ヶ月完成できなかった案件を、引き継いで3週間で動く状態へ',
        challenge:
      ...
      },
      {
        ...
        challenge:
          'リリース済みの大規模toCアプリを、課金・広告・通知を止めないままFlutterへ移行する必要がありました。',
        solution:
          '移行しながら、要件・設計判断・却下理由・受入条件をユースケース単位で記録し、そのままE2Eテストへつなぎました。',
        whyUs:
          '「なぜこの設計なのか」をコードから推測し直さずに済むよう、判断の経緯ごと残します。担当者が変わっても仕様を追跡しながら継続開発できます。',
        results: ['配信を止めずに移行', '設計判断の経緯が残る', 'リリース前の動作確認を自動化'],
      },
      {
  ...
  },
  {
    ...
    caseStudies: [
      {
        title: '社内ヘルプデスクをAIへ移し、情シスの時間を戻した（SaaS企業・従業員100名）',
        challenge:
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          '固定の価格表は置いていません。NDA締結後に実データを確認し、0円で検証用デモを作ってから、実現の見込みがある場合だけPoCへ進みます。PoC以降は準委任（月額）で、単価は職種別に公開しています。デモで分かったデータの状態と難しさをもとに、確かめる範囲と体制を再見積もりして提示します。合わなければ、デモの段階で終了でき、費用はかかりません。',
      },
      {
  ...
  },
  {
    ...
    caseStudies: [
      {
        title: 'ベクトル検索だけでは届かない検索を、Hybrid GraphRAGで成立させた',
        challenge:
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'NDA締結後にFAQや過去の問い合わせデータを確認し、0円で検証用デモを作ります。実現の見込みがあれば、デモで見えた範囲に絞ってPoCを準委任（月額）で再見積もりし、マルチチャネル対応・有人切り替え・分析ダッシュボードなどの本番化も同じ体制で続けます。期間はFAQの件数と連携先で変わるため、デモの結果を見て提示します。',
      },
      {
  ...
  },
  {
    ...
    caseStudies: [
      ...
      },
      {
        ...
        whyUs:
          '手書きの帳票には読み取り誤りが生じるため、確認が必要な項目と担当者を先に決めます。原本と照合して修正できる画面を設け、確認後に登録する流れを設計します。',
  ...
  },
  {
    ...
    caseStudies: [
      {
        title: '上流工程AIエージェントを自社で開発し、毎日の開発現場で運用している',
        challenge:
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          'NDA締結後に対象業務のデータと連携先を確認し、1業務フローに絞って0円で検証用デモを作ります。実現の見込みがあれば、デモで見えた不確実性だけを範囲にしてPoCを準委任（月額）で再見積もりし、ツール連携・ガバナンス設計・運用基盤を含む本番化も同じ体制で進めます。対象業務の複雑さと連携するシステム数で期間と体制が変わります。',
      },
      {
  ...
  },
  {
    ...
    faq: [
      ...
      {
        question: 'PM on Railsは、一般的なプロジェクト管理ツールと何が違いますか？',
        answer:
      ...
      {
        question: 'PM on Railsを使わずに依頼することもできますか？',
        answer:
  ...
  },
  {
    ...
    description:
      'アイデアや新規事業を、大きく作る前に小さく検証するためのMVP・PoC・プロトタイプ開発です。PoC（概念実証）は「実現できるか」を確かめる検証、MVPは「価値があるか」を確かめられる最小限の製品を指します。検証項目の設計から入り、簡易デモや検証用プロトタイプで投資判断の材料を揃えます。',
    longDescription:
  ...
  },
  {
    ...
    caseStudies: [
      ...
      {
        title: 'ヒアリング議事録からRFPを作り、その日のうちに動くデモまで進めた案件',
        challenge:
