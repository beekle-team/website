...
export const ragService: ServiceDetail = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '検証・PoCは80万〜500万円、本番開発は600万〜1,200万円、継続運用は月20万〜100万円が目安です。80万円台は対象データや機能を絞った小規模検証を想定しています。データ量、連携先、権限、評価範囲によって費用は変わるため、初回相談後に内訳付きで見積もります。複数基盤や高い可用性、継続的なAI・PM体制が必要な運用は月120万円以上になる場合があります。',
    },
    {
